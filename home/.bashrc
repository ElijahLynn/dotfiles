...
# CLIPBOARD ALIASES/FUNCTIONS leveraging the cb() function
# ------------------------------------------------
...
# Add custom Git completion to shell aliases
if [ -f ~/bin/git-completion.sh ]; then
    . ~/bin/git-completion.sh
fi

# Drush completion, to add support for non-standard aliases edit the last line of the file below.
if [ -f ~/.drush/drush.complete.sh ]; then
    . ~/.drush/drush.complete.sh
fi

# Write history all the time, for all terminals.
